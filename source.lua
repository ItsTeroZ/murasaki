...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local murasakiLogo = Instance.new("ImageLabel")
    local hashLogo = Instance.new("ImageLabel")
    local murasaki = Instance.new("TextLabel")
    ...
    murasakiLogo.Name = "MLogo"
    murasakiLogo.Parent = background
    murasakiLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    murasakiLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    murasakiLogo.BackgroundTransparency = 1.000
    murasakiLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    murasakiLogo.Size = UDim2.new(0, 448, 0, 150)
    murasakiLogo.Visible = true
    murasakiLogo.Image = "http://www.roblox.com/asset/?id=12795097939"
    murasakiLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    murasakiLogo.ImageTransparency = 1
    ...
    murasaki.Name = "M"
    murasaki.Parent = background
    murasaki.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    CreateTween("MRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(murasakiLogo, TweenTable["MRotation"], {Rotation = murasakiLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(murasaki, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(murasakiLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(murasakiLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(murasaki, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
