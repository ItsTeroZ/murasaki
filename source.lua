...
local library = {design = getgenv().design == "uwuware" and "kali" or "uwuware", tabs = {}, draggable = true, flags = {}, title = "Reich Hub", open = false, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "reich_cfg", fileext = ".txt"}
